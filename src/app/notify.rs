...
const fn notification_text(event: NotifyEvent) -> &'static str {
    match event {
        NotifyEvent::PermissionRequired => "Mochi: Permission required",
        NotifyEvent::QuestionRequired => "Mochi: Question required",
        NotifyEvent::TurnComplete => "Mochi: Turn complete",
    }
}
    ...
    fn iterm2_uses_osc9_when_supported() {
        assert_eq!(
            ...
            NotificationPlan {
                ring_bell: false,
                send_desktop: false,
                osc9_text: Some("Mochi: Turn complete"),
            }
        );
    }
    ...
    fn iterm2_with_bell_uses_osc9_and_bell_when_supported() {
        assert_eq!(
            ...
            NotificationPlan {
                ring_bell: true,
                send_desktop: false,
                osc9_text: Some("Mochi: Permission required"),
            }
        );
    }
